...
public class InGameMenu extends JFrame {
  ...
  public InGameMenu(Game game) {
    ...
    JButton drawButton =
        new JButton((board.hasOfferedDraw(!board.isWhiteTurn()) ? "Accept" : "Offer") + " Draw");
    if (board.hasOfferedDraw(board.isWhiteTurn())) {
      drawButton.setText("Draw Offered");
    }
    ...
    drawButton.addActionListener(e -> {
      board.offerDraw();
      if (drawButton.getText().equals("Offer Draw")) {
        drawButton.setText("Draw Offered");
      }
    });
    this.add(drawButton);
